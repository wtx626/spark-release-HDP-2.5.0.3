    ...
    if (!isZombie) {
      ...
      dequeueTask(execId, host, allowedLocality) match {
        case Some((index, taskLocality, speculative)) => {
          ...
          //ShuffleMapStage:Starting task 0.0 in stage 0.0 (TID 0, hadoop-s-32, partition 0,NODE_LOCAL, 2225 bytes)
          //ShuffleMapStage:Starting task 1.0 in stage 0.0 (TID 1, hadoop-s-33, partition 1,RACK_LOCAL, 2225 bytes)
